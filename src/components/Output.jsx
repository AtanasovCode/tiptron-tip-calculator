...
const Output = ({ totalBill, tipPerPerson, split, reset, checkValues }) => {
  const disabledButtonStyles = checkValues() ? "opacity-100 cursor-pointer" : "opacity-20 cursor-not-allowed";
    ...
    <div className="flex-1 bg-very-dark-cyan text-white p-6 rounded-xl flex flex-col justify-between w-full">
      ...
      <div className="w-full">
        <input
          ...
          value="reset"
          className={`
            w-full p-4 bg-strong-cyan text-very-dark-cyan rounded-lg uppercase cursor-pointer hover:bg-light-grayish-cyan
